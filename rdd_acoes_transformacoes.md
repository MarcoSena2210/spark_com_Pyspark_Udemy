...
# RDD - Ações e Transformações usando pyspark 
...
⚠ Dica: Não deve ser usado em ambiente de produção 
 `numeros.collect()`
...
# TRANSFORMAÇÕES:
##  Filtro -> filter()
### Filtrar os números maior que 2.
...
### Criar outro RDD (numero2 ) para fazer algumas operações entre eles.
